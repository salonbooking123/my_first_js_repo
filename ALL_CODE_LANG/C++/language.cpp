...
//     }
    ...
    //      cout << "L-Iteration_for(3) -> " <<lower_bound(v.begin(), v.end(),2 )-v.begin()<<" : "<<*lower_bound(v.begin(), v.end(),3 ) << endl;
    //      cout << "U-Iteration_for(3) -> " <<upper_bound(v.begin(), v.end(),2 )-v.begin()<<" : "<<*upper_bound(v.begin(), v.end(),3 ) << endl;
    ...
    //     }
    //     cout <<endl;
    // //     cout <<"after rotating/shifting the reversed value by 1 in clockwise= "<<endl;
    //     rotate(v.begin(),v.begin()+1,v.end());
    //     for(int i:v){
    //         cout <<i<<" ";
    //     }
    //     cout <<endl;
    //     cout <<"after rotating/shifting the new_reversed value by 2 in clockwise= "<<endl;
    //     rotate(v.begin(),v.begin()+2,v.end());
    //     for(int i:v){
    //         cout <<i<<" ";
    //     }
    //     cout <<endl;
    //     cout <<"after rotating/shifting the new_reversed value by n in clockwise= "<<endl;
